...
//
// The message is deliberately not the raw error: fab-tier costs are pricing data
// and therefore Confidential (ARCHITECTURE.md §7), and a Postgres error string
// can name tables, columns, and RLS policies. `error.digest` is the server-side
